...
corr_max = 0.1
corr_min = -0.01
acf(lambda1s[BURN : S], xlim = c(1, Kmax), ylim = c(corr_min, corr_max), lag.max = Kmax)
acf(lambda2s[BURN : S], xlim = c(1, Kmax), ylim = c(corr_min, corr_max), lag.max = Kmax)
acf(ms[BURN : S], xlim = c(1, Kmax), ylim = c(corr_min, corr_max), lag.max = Kmax)
THIN = 10
#plot
